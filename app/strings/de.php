...
const UI_STRINGS = [
  ...
  'help_wichtig_2' => 'Die Band entscheidet in den Einstellungen, ob es diese Mails überhaupt gibt und wer kennzeichnen darf — sonst wird das Ausrufezeichen Alltag. Das einzelne Mitglied kann sie nicht abstellen: Sie erreicht sonst genau die nicht, die selten hineinsehen. Zweimal kennzeichnen schickt keine zweite Mail, und wer selbst kennzeichnet, bekommt keine. Zurücknehmen geht jederzeit und verschickt nichts — ein Widerruf ist keine Nachricht. Zurzeit steht der Knopf an den Terminen; sag Bescheid, wenn er woanders auch gebraucht wird.',
  // Tagesmail (#332)
