...
const UI_STRINGS = [
  ...
  'help_flow_gig' => 'Von der Anfrage bis zum Geld: Jemand fragt an, ihr legt einen Termin an. Aus dem Termin rechnet ihr ein Angebot — Datum und Spielzeit holt es sich von dort. Sagt der Veranstalter zu, wird aus dem Angebot ein Vertrag, und die Gage wandert mit, damit nicht zwei Zahlen nebeneinander leben. Am Termin steht danach, ob das unterschriebene Blatt zurück ist. Soll der Veranstalter eine Rechnung bekommen, setzt ihr am Termin den Haken „Rechnung erstellen" — sie entsteht aus dem Vertrag, mit Veranstalter, Datum und Betrag. Nach dem Auftritt übernehmt ihr die Gage in die Kasse, und am Jahresende steht sie in der Steuerübersicht.',
  'help_flow_direct' => 'Von der Anfrage bis zum Geld: Jemand fragt an, ihr legt einen Termin an und schickt den Vertrag dazu. Datum, Spielzeit und Gage holt er sich vom Termin, ihr müsst nichts abschreiben. Fragt jemand vorher nach dem Preis, rechnet ihr ihn am Termin mit „Preis rechnen" aus eurer Preisliste aus; die Summe wandert als Gage in den Vertrag. Kommt der Vertrag unterschrieben zurück, vermerkt ihr das, und am Termin steht ab da, dass das Papier da ist. Soll der Veranstalter eine Rechnung bekommen, setzt ihr am Termin den Haken „Rechnung erstellen" — sie entsteht aus dem Vertrag. Nach dem Auftritt übernehmt ihr die Gage in die Kasse, und am Jahresende steht sie in der Steuerübersicht. Wollt ihr das Rechenblatt als eigenes Angebot verschicken, bevor der Vertrag kommt, stellt ihr in den Einstellungen auf den zweistufigen Weg um.',
  'help_flow_setlist' => 'Was auf der Bühne passiert: Songs sammelt ihr einmal, eine Setliste ist eine Auswahl daraus in Reihenfolge. Die Setliste hängt ihr an den Termin. Der Stagerider beschreibt, was ihr an Technik braucht, und gilt für alle Auftritte gleich — er hängt nicht am einzelnen Termin. Gedruckt sehen Setliste, Rider, Angebot, Vertrag und Rechnung gleich aus, weil sie sich denselben Kopf mit Logo und Wasserzeichen teilen.',
  ...
  'ev_needs_invoice' => 'Rechnung erstellen',
  ...
  // Hilfe
  'help_angebote_5' => 'Wo ihr das Blatt findet, hängt am gewählten Weg. Geht es als Angebot hinaus, steht „Angebote" im Menü. Bleibt es im Haus, führt der Knopf „Preis rechnen" am Termin hin — dasselbe Blatt, nur ohne eigenen Menüpunkt, weil es dann niemand außer euch zu sehen bekommt.',
  ...
  'help_task_contract' => 'einen Vertrag aufsetzen und verschicken',
  'help_task_invoice' => 'dem Veranstalter eine Rechnung schreiben',
