...
<?php // Die anklickbaren Marken stehen unter der Zusammenfassung, nicht darin:
      // Ein Verweis in einem <summary> ist nicht vorgesehen, und die Browser
      // sind sich uneins, ob ein Klick ihm folgt, die Karte umschaltet — oder
