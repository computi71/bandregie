...
<head>
  ...
  <?php // Passkey: blendet sich selbst ein, wenn der Browser es kann — auf der
        // Anmeldeseite zum Anmelden, im Profil zum Anlegen. ?>
  <script src="<?= e(asset('/assets/passkey.js')) ?>" defer></script>
