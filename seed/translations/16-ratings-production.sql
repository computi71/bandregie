...
('en','rate_title','Rating'),('en','rate_your','Your rating'),('en','rate_avg','Average'),
...
('nl','rate_title','Beoordeling'),('nl','rate_your','Jouw beoordeling'),('nl','rate_avg','Gemiddelde'),
...
('fr','rate_title','Note'),('fr','rate_your','Ta note'),('fr','rate_avg','Moyenne'),
...
('es','rate_title','Valoración'),('es','rate_your','Tu valoración'),('es','rate_avg','Media'),
...
('it','rate_title','Valutazione'),('it','rate_your','La tua valutazione'),('it','rate_avg','Media'),
