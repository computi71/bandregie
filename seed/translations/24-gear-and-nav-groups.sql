...
('en','inavg_band','Band'),('en','inavg_konto','Account'),
...
('fr','inavg_band','Groupe'),('fr','inavg_konto','Compte'),
...
('es','inavg_band','Banda'),('es','inavg_konto','Cuenta'),
...
('nl','inavg_band','Band'),('nl','inavg_konto','Account'),
...
('it','inavg_band','Band'),('it','inavg_konto','Account')
