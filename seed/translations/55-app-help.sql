...
('en','app_install_push','Notifications do not exist yet: to learn that an event was added or somebody cancelled, you have to open Bandregie. They are planned.'),
...
('fr','app_install_push','Les notifications n''existent pas encore : pour savoir si une date s''est ajoutée ou si quelqu''un s''est décommandé, il faut ouvrir Bandregie. Elles sont prévues.'),
...
('es','app_install_push','Los avisos todavía no existen: para saber si se ha añadido una fecha o si alguien ha cancelado hay que abrir Bandregie. Están previstos.'),
...
('nl','app_install_push','Meldingen zijn er nog niet: wie wil weten of er een datum bij is gekomen of dat iemand heeft afgezegd, moet Bandregie openen. Ze staan op de planning.'),
...
('it','app_install_push','Le notifiche non ci sono ancora: per sapere se è stata aggiunta una data o se qualcuno ha dato forfait bisogna aprire Bandregie. Sono in programma.')
