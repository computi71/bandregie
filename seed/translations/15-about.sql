...
('en','about_thanks','Born out of one band''s frustration with its own organization — and open to everyone who feels the same.'),
...
('nl','about_thanks','Ontstaan uit de frustratie van één band over de eigen organisatie — en open voor iedereen die dat herkent.'),
...
('fr','about_thanks','Né de l''exaspération d''un groupe face à sa propre organisation — et ouvert à tous ceux qui s''y reconnaissent.'),
...
('es','about_thanks','Nació del hartazgo de una banda con su propia organización — y está abierto a quien se sienta igual.'),
...
('it','about_thanks','Nato dall''insofferenza di una band verso la propria organizzazione — e aperto a chiunque si riconosca.'),
