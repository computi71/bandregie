...
('en','about_thanks','Born out of the needs of a band that always found organizing a challenge. There are plenty of ideas left.'),
...
('nl','about_thanks','Ontstaan uit de behoefte van een band voor wie de organisatie altijd een uitdaging was. Ideeën zijn er nog genoeg.'),
...
('fr','about_thanks','Né des besoins d''un groupe pour qui l''organisation a toujours été un défi. Les idées ne manquent pas.'),
...
('es','about_thanks','Nació de la necesidad de una banda para la que organizarse siempre fue un reto. Ideas no faltan.'),
...
('it','about_thanks','Nato dalle esigenze di una band per cui organizzarsi è sempre stata una sfida. Di idee ce ne sono ancora parecchie.'),
