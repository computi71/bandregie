...
('en','help_equipment','The inventory with parts, prices and deadlines such as inspections or insurance.'),
...
('fr','help_equipment','L''inventaire avec composants, prix et échéances comme contrôles ou assurances.'),
...
('es','help_equipment','El inventario con componentes, precios y plazos como revisiones o seguros.'),
...
('nl','help_equipment','De inventaris met onderdelen, prijzen en termijnen zoals keuringen of verzekeringen.'),
...
('it','help_equipment','L''inventario con componenti, prezzi e scadenze come revisioni o assicurazioni.'),
